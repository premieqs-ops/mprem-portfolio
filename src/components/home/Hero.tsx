      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full py-16 md:py-24">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-8">
            ...
            >
              I Build{" "}
              <span className="text-gradient">Digital Strategies</span> That
            ...
            >
              From digital marketing and lead generation to business development
              and growth strategy, I combine creative thinking with practical
              execution to help businesses create meaningful digital momentum.
            </motion.p>
