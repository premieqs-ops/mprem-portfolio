      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {(profile.currentlyExploring || []).map((item) => (
                  <span
                    key={item}
                    className="px-3 py-1 rounded-full text-xs font-medium glass border-accent/15 text-accent-light"
                  >
                    {item}
                  </span>
                ))}
            ...
            <Link
              href="/about"
              className="inline-flex items-center gap-2 text-accent-light hover:text-accent font-medium transition-colors group"
            >
              Full story
